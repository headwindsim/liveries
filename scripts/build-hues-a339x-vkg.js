...
const LIVERY_SRC = path.resolve(__dirname, '..', 'hues-a339x-vkg/src');
const LIVERY_OUT = path.resolve(__dirname, '..', 'hues-a339x-vkg/out');
...
createPackageFiles(path.resolve(LIVERY_OUT, 'hues-livery-a339x-sunclass-package'), 'manifest-base.json');
