...
const LIVERY_SRC = path.resolve(__dirname, '..', 'hues-a339x-cfg/src');
const LIVERY_OUT = path.resolve(__dirname, '..', 'hues-a339x-cfg/out');
...
createPackageFiles(path.resolve(LIVERY_OUT, 'hues-livery-a339x-condor-package'), 'manifest-base.json');
